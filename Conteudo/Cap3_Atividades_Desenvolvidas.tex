...
% inability to absorb new information may be the first indication of a subclinical disease process in an aging person

% Some elders have increasing difficulty understanding complex sentences, are less proficient than younger people in drawing inferences, and have problems with motor tasks.

% Mais ou menos - It is important to reduce environmental distractions, both to compensate for any age-related hearing loss and to help the patient with attention and concentration

% Colocar as dificuldades dos idosos: perda de visão, perda de audição, perda de coordenação motora, de memoria, limitações do sistema nervoso, etc --- e ao lado colocar ações que serão tomadas para evitar problemas

% With advancing age, a person’s memory is better for information that is heard than it is for information that is seen. Therefore, an older person is more likely to remember information he or she hears than information that he or she reads. To increase learning for a patient with memory loss, REPEAT THE MESSAGE FREQUENTLY, and question the patient regularly to determine the level of retention.


% The burden of impatience, related to a negative emotional
% attitude to students who have some difficulty acquiring new skills, is the factor that makes their
% learning even more difficult” (Tomczyk, 2015, p. 215)
% O app deverá prover sensações emocionais positivas para motivar estudantes, isso é essencial pois de acordo com o estudo isso é um fator importante...

% ====================================

% Thus, in our view, “in education for seniors the teacher's ability to identify
% individual needs of their students and typologize them properly, related to the ability to select
% and apply their personal competencies, are extremely important” (Jaroszewska, 2010, p. 108).
% This is the next area that needs (re)construction in order to meet seniors’ expectations connected
% with their education. 
% Falar da importancia do professor analisar as dificuldades individuais de grupos de alunos idosos, falar q a pesquisa (a primeira) mostrou a diferença grande entre as maneiras de se ensinar para grupos diferentes.

% This study concludes that students styles of
% learning are different so teaching styles should also be made compatible with learning
% style. 
% \cite{learn2teach}

% TOP: In order for the teaching-learning plan to be effective, it must be individualized to fit the needs and lifestyle of the older patient, and in order for goals to be mutually acceptable,


% Em conjunto com esses 3, falar que o app proporciona texto, audio, video e jogo, corroborando com o estilo de aprendizado de cada um
% ====================================

% , declare
% that work in small groups is the most effective when it comes to educational activities for
% seniors. They reject traditional methods of work, expecting education based on personal
% relationships, which is much easier in small groups. 
% Trabalhos em grupos são vistos como os mais efetivos. Rejeitam metodos tradicionais e esperam aprender com base em relações interpessoais. Seria interessante propor a aplicação do app em grupos de idosos, em que eles se juntassem em um celular e fizessem juntos, algo do tipo
...
% Já puxa falando da educação continuada: Dentre as possibilidades há a educ cont...
...
% A partir daqui há o foco nas técnicas de ensino propriamente ditas, acima daqui explica o contexto da educação para idosos
% TENTAR ESCREVER ALGO PARA DEIXAR CLARO QUE TRATAREMOS DE AÇÕES A SEREM TOMADAS PARA O ENSINO, QUE A PARTE DE CONTEXTO ACABOU
...
\begin{figure}[H]
\centering
    \caption{\textit{Framework Scrum}}
    \label{fig:scrum}
    \includegraphics[width=0.9\textwidth]{Figuras/scrum.png}
...
A primeira abordagem para a solução do problema seria simplesmente utilizar o paradigma da Força Bruta. Porém, a análise só seria feita no último passo.
...
\centering
    ...
    \includegraphics[width=0.7\textwidth]{Figuras/entrelacamento.jpg}
...
\centering
    ...
    \label{fig:markov1}
    \includegraphics[width=0.8\textwidth]{Figuras/markovChain1.jpg}
    
    Fonte: Elaborada pelo autor
\end{figure}

Todavia, ainda é possível aumentar a eficiência do algoritmo. O algoritmo anterior verifica a possibilidade de inserção de uma palavra examinando até a posição $i$, não considerando com antecedência impossibilidades das linhas ou colunas , como na Figura \ref{fig:scaffolding}, que tem a última coluna sendo iniciada com \textbf{SR} (palavras de 5 letras iniciadas com \textbf{SR} são inexistentes no banco de palavras usado). Dessa maneira, diversos passos ainda são executados mesmo com uma formação impossível de tabuleiro.
