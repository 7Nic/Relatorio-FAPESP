...
%Nesse sentido, ressalta-se que o aluno realizou um minicurso sobre UI/UX, com o título ``\textit{Como incluir UX e UI Design nos seus projetos}'', ocorrido na 22ª Semana da Computação da Universidade de São Paulo, campus de São Carlos, no dia 03/10/2019. O minicurso se mostrou de grande importância, uma vez que possibilitou a expansão do conhecimento do assunto em termos práticos, sendo possível sua aplicação no projeto.
